...
[Validator]
public class UploadCurrencyAttributeByExcelCommandValidator : AbstractValidator<UploadCurrencyAttributeByExcelCommand>
{
    public UploadCurrencyAttributeByExcelCommandValidator()
    {
