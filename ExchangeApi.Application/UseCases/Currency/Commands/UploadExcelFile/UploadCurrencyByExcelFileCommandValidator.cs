...
[Validator]
public class UploadCurrencyByExcelFileCommandValidator : AbstractValidator<UploadCurrencyByExcelFileCommand>
{
    public UploadCurrencyByExcelFileCommandValidator()
    {
