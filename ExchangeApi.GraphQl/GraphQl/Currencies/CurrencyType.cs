...
public class CurrencyType : ObjectType<Currency>
{
    protected override void Configure(IObjectTypeDescriptor<Currency> descriptor)
    {
        ...
        descriptor.Field(u => u.Description)
                .Description("A brief description of the currency.");
        
        descriptor.Field(u => u.Volume24h)
                .Description("The 24-hour trading volume of the currency.");
        
        descriptor.Field(u => u.CreatedAt)
                .Description("The date and time when the currency was created.");
        
        descriptor.Field(u => u.UpdatedAt)
                .Description("The date and time when the currency was last updated.");
    }
    ...
    private class Resolvers(AppDbContext context)
    {
        ...
        {
            return context.TradingPairs
                    .Where(w => w.Id == currency.Id);
        }
    }
}